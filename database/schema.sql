...
('Admin', 'User', 'admin@nexaui.com', '$2a$12$X.Xi/tB/Sd9QqLldM/Tk/.h1ZnlZ/2rRC/ejaMBTDFaoWTO5U5K.2', 'admin', 1, 1),
...
INSERT INTO user_profiles (user_id, phone, location, website, social_links) VALUES
  (1, NULL, 'San Francisco, CA', 'https://admin.nexaui.com', '{"twitter": "admin_nexaui", "linkedin": "admin-nexaui", "github": "admin-nexaui"}'),
